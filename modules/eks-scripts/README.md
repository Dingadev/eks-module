...
[examples/eks-cluster-with-supporting-services/packer/build.json](/examples/eks-cluster-with-supporting-services/packer/build.json).
...
1. The EC2 instance must be running an [Amazon EKS-optimized AMI](https://aws.amazon.com/marketplace/pp/B00U6QTYI2/).
1. The EC2 instance must have the AWS CLI installed.
1. The EC2 instance must have a version of Python installed.
...
using the [eks-cluster-workers module](../eks-cluster-workers), this is automatically attached to the worker IAM role.

### map_ec2_tags_to_node_labels.py symlink
