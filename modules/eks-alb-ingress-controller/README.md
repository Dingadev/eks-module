...
This module uses the [community helm chart](https://github.com/helm/charts/tree/8faca09ce7d71defd7e571c9e17b9c0498d204a6/incubator/aws-alb-ingress-controller), with a set of best practices input.
...
controller](https://github.com/kubernetes/ingress-nginx/blob/master/README.md), each `Ingress` resource translates into
